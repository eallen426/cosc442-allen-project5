...
public class Utilities{
  ...
  public static void generateTestCases(State [] FSM, Vector<String> tests)
  {
	  for(int i=0; i<tests.size();i++)
	  {
		  if(runFSM2(FSM, 1, WMethod.addSpaces(tests.get(i)), " ").contains("y"))
		  {
			  System.out.println("@Test");
			  System.out.println("public void testCase" + i + "(){");
			  System.out.println("	assertEquals(true, runFSM2(FSM, 1, \""+WMethod.addSpaces(tests.get(i))+"\", \" \").contains(\"y\"));");
			  System.out.println("}");
		  }
		  else
		  {
			  System.out.println("@Test");
			  System.out.println("public void testCase" + i + "(){");
			  System.out.println("	assertEquals(false, runFSM2(FSM, 1, \""+WMethod.addSpaces(tests.get(i))+"\", \" \").contains(\"y\"));");
			  System.out.println("}");
		  }
		  System.out.println();
	  }
  ...
  public static void generateTestCases2(State [] FSM, Vector<String> tests)
  {
	  for(int i=0; i<tests.size();i++)
	  {
		  if(runFSM2(FSM, 1, WMethod.addSpaces(tests.get(i)), " ").contains("y"))
		  {
			  System.out.println("@Test");
			  System.out.println("public void testCase" + i + "(){");
			  System.out.println("	fixture=new JamesBond();assertEquals(true, fixture.bondRegex(\""+WMethod.addSpaces(tests.get(i))+"\"));");
			  System.out.println("}");
		  }
		  else
		  {
			  System.out.println("@Test");
			  System.out.println("public void testCase" + i + "(){");
			  System.out.println("	fixture=new JamesBond();assertEquals(false, fixture.bondRegex(\""+WMethod.addSpaces(tests.get(i))+"\"));");
			  System.out.println("}");
		  }
		  System.out.println();
	  }
  ...
  public static String runFSM2(State [] FSM, int stateID, String input, String separator){
